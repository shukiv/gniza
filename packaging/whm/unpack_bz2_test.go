...
// The WHM installer had the same hard requirement as the DirectAdmin
// one, and would stop the same way. restic is published as a .bz2 and
// nothing else, so something on the machine has to read one -- a
// DirectAdmin server on 2026-09-10 stopped at
//
